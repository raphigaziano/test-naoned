...
différents couches couches de l'application.
...
regrouper certaines fonctionnalités communes, il y a toutefoies beaucoup de 
...
(js ou css) spécifiques à certaines pages: Avec le fonctionnement actuelle, 
...
fonctionnel du site, et n'ai pas eu le temps de m'y repencher.
...
qu'il s'agit d'une compétence utils dans ce métier, j'ai toutefois décider
de continuer.
